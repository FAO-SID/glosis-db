...
psql -h localhost -p 5432 -d sislac -U eloi -c "
	...
	CONSTRAINT profile_pkey PRIMARY KEY (profile_id),
        ...
        INSERT INTO result (layer_id, glosis_property_uri, property_pretty_name, unit, glosis_procedure_uri, property_source, value) SELECT layer_id, NULL, 'Carbonates', NULL, NULL, 'co3', co3 FROM sislac_zenodo WHERE co3 IS NOT NULL;
