...
-- Unnecessary trigger, table result_value_specimen does not exist
...
-- ALTER FUNCTION core.check_result_value_specimen()
--     OWNER TO glosis;

-- COMMENT ON FUNCTION core.check_result_value_specimen()
--     IS 'Checks if the value assigned to a result record is within the numerical bounds declared in the related observation (fields value_min and value_max).';
